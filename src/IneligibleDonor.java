...
public class IneligibleDonor extends Donor {
	...
	public IneligibleDonor(String name, String email, String address, String phoneNo, int age, String gender, String bloodGroup, LocalDate date) throws RemoteException{
		this.name = name;
		this.email = email;
